...
public class UserController {
    ...
    @PostMapping("/login")
    public R<String> login(HttpServletRequest request, @RequestBody com.example.wanchengdemo.entity.data.User user){
        // 1.将密码进行MD5加密
   ...
   //     pwd = DigestUtils.md5DigestAsHex(pwd.getBytes());
        ...
        //2.根据页面提交的用户名来查询数据库
        LambdaQueryWrapper<com.example.wanchengdemo.entity.data.User> queryWrapper = new LambdaQueryWrapper();
        queryWrapper.eq(com.example.wanchengdemo.entity.data.User::getUsername,user.getUsername());
        com.example.wanchengdemo.entity.data.User ump = userService.getOne(queryWrapper);
